...
def summary1(model, clip_frames, clip_bboxes, clip_indice, clip_labels, a):
...
#         clip_frames, clip_bboxes, clip_indice, clip_labels, a = input_size   
        # print(type(x[0]))
        # create properties
        summary = OrderedDict()
        hooks = []
        ...
        # make a forward pass
        # print(x.shape)
        model(clip_frames, clip_bboxes, clip_indice, clip_labels, a)
        # remove these hooks
        for h in hooks:
            h.remove()
